...
def propagation(args, frame_inapint_model=None):
    ...
    output_root = args.output_root_propagation  # '.../demo/Inpaint_Res'
    ...
    image = cv2.resize(image, (shape[1], shape[0]))  # don't change the shape shape[1]-width, shape[0]-height
    iter_num = 0
    result_pool = [
